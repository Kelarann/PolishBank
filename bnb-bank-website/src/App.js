...
const App = () => {
  ...
  <Helmet>
    ...
    <meta name="description" content="BnB Bank ." />
    <meta name="keywords" content="BnB Bank, Blockchain, DAO, Decentralized, Cryptocurrency, Transparency, Security" />
    <meta name="author" content="BnB Bank Team" />

    <meta property="og:title" content="BnB Bank" />
    <meta property="og:description" content="Join BnB Bank " />
    <meta property="og:image" content="%PUBLIC_URL%/logo.png" />
    <meta property="og:url" content="https://bnbbank.com" />
    <meta property="og:type" content="website" />

    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="BnB Bank" />
    <meta name="twitter:description" content="Join BnB Bank " />
  ...
  const socials = [
    {
      network: 'telegram',
      url: 'https://t.me/BnBBank',
      name: 'BnBBank',
    },
    {
      network: 'twitter',
      url: 'https://x.com/BnBBank',
      name: 'CommunityBlockchain',
    },
    {
      network: 'email',
      url: 'mailto:devteam@bnbbank.com',
      name: 'devteam@bnbbank.com',
    },
    {
      network: 'github',
      url: 'https://github.com/DevTeamBnBBank',
      name: 'https://github.com/DevTeamBnBBank',
    }
  ];
  ...
  return (
    <div className="App">
      <header className="App-header">
        <img src={logo} alt="BnB Bank Logo" className="App-logo" />
        <h1 class="app-text" >BnB Bank</h1>
        <nav>
          <ul>
          ...
          <div className="contract-address">
            <h2 class="app-text">Official Contract Address</h2>
      ...
      <Element name="about" className="section">
        <div className="about-container">
          <div className="about-text">
            <h1>BNB BANK Training Project</h1>
